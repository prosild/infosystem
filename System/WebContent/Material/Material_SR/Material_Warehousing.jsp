...
<ul>
	...
	<li class="topMenuLi">
		...
		<ul class="submenu">
			<li>
				<a class="submenuLink" href="../Material_Register/Material_Register.jsp">자재등록</a>
			</li>
			<li>
				<a class="submenuLink" href="../Material_Stock/Material_Stock_Check.jsp">자재재고확인</a>			
			</li>
			<li>
				<a class="submenuLink" href="Material_SR_Register.jsp">자재입출고등록</a>			
			</li>
		</ul>
	</li>
	<li class="topMenuLi">
...
<h1 align="center">자재입고내역</h1>
	...
	<%
		...
		try{
			...
			sql = "SELECT material_warehousing.Material_Material_Num, material_warehousing.MW_Date, material_warehousing.MW_Amount, material.Material_Name, material.Material_Price from Material_Warehousing join material on material_warehousing.Material_Material_Num = Material.Material_Num";
			rs = stmt.executeQuery(sql);
			
			while(rs.next()){
				Material_Num = rs.getString("Material_Material_Num");
				Material_Name = rs.getString("Material_Name");
				MW_Amount = rs.getString("MW_Amount");
				MW_Date = rs.getString("MW_Date");
				Material_Price = rs.getString("Material_Price"); %>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%= MW_Amount %>" disabled>
							</td>
							<td>
								<input type="text" value="<%= MW_Date %>" size="27" disabled>
							</td>
							<td>
								<input type="text" value="<%= Material_Price %>" disabled>
							</td>
						</tr>
		<% } %>
				</table>
