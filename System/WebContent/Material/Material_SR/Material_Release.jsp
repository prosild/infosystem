...
<h1 align="center">자재출고내역</h1>
	...
	<%
		...
		try{
			...
			sql = "SELECT material_release.Material_Material_Num, material_release.MR_Date, material_release.MR_Amount, material.Material_Name, material.Material_Price from Material_release join material on material_release.Material_Material_Num = Material.Material_Num";
			...
			while(rs.next()){
				...
				Material_Price = rs.getString("Material_Price"); %>
						<tr>
							...
							<td>
								<input type="text" value="<%= MR_Amount %>" disabled>
							</td>
							<td>
								<input type="text" value="<%= MR_Date %>" size="27" disabled>
							</td>
							<td>
