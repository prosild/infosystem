...
<nav id="topMenu">
	<ul>
		...
		<li class="topMenuLi">
			...
			<ul class="submenu">
				<li>
					<a class="submenuLink" href="Material_Register.jsp">자재등록</a>
				</li>
				<li>
	...
	<%
		...
		try{
			...
			String sql = "SELECT * FROM Material WHERE Material_Num='" + Material_num + "'";
			...
			while(rs.next()){
				...
				%>
						<tr>
							...
							<td>
								<input type="text" name="Material_Price" value="<%= Material_Price %>" >
							<td>
