	...
	<ul>
		...
		<li class="topMenuLi">
			...
			<ul class="submenu">
				...
				<li>
					<a class="submenuLink" href="Material_Stock_Check.jsp">자재재고확인</a>			
				</li>
				<li>
					<a class="submenuLink" href="../Material_SR/Material_SR_Register.jsp">자재입출고등록</a>			
				</li>
			</ul>
		</li>
		<li class="topMenuLi">
...
<h1 align="center">자재재고내역</h1>
	...
	<%
		...
		String MS_Amount = null;
		String MS_Date = request.getParameter("MS_Date");
		String sql;
		
		try{
			conn = DriverManager.getConnection(url, "root", "postscript1!");
			stmt = conn.createStatement();
			sql = "select material_stock.Material_Material_Num, material_stock.MS_Date, material_stock.MS_Amount, material.material_Name from material_stock join material on material_stock.Material_Material_Num = material.Material_Num where material.Material_Name = '" + Material_Name + "' and material_stock.MS_Date like '" + MS_Date + "%'";
			rs = stmt.executeQuery(sql);
			
				rs.last();
				Material_Num = rs.getString("Material_Material_Num");
				Material_Name = rs.getString("Material_Name");
				MS_Amount = rs.getString("MS_Amount");
				MS_Date = rs.getString("MS_Date");
		 %>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%= MS_Date %>" size="27" disabled>
							</td>
						</tr>
				</table>
			</form>
