...
<h1 align="center">생산지시서작성</h1>
	<form action="Production_Directions_Register2.jsp">
	...
	<%
		...
		try {
			...
			rs.last();
				Product_Num[i] = rs.getString("Product_Num");
	...
	%>
			<tr>
				...
				<td><input type="text" value="<%=PS_Amount %>"	 disabled></td>
				<td><input type="text" name="PD_Amount"></td>
			</tr>
	<%
