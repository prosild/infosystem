...
<h1 align="center">생산지시서작성</h1>
	<form action="Production_Directions_Register1.jsp">
		<table align="center" border="1">
			<tr>
				<td colspan="2">제품번호</td>
				<td>제품명</td>
	<%
	...
	%>
			<tr>
				<td><input type="checkbox" name="Product_Num" value="<%=Product_Num%>">
				<td><input type="text" value="<%=Product_Num%>" disabled></td>
