...
<%
		...
		try {
			...
			rs = stmt.executeQuery("select * from product where Product_Num='" + Product_Num + "'");
...
<table align="center" border="1">
	...
	<%
		try {
			conn = DriverManager.getConnection(url, "root", "postscript1!");
			stmt = conn.createStatement();
			rs = stmt.executeQuery("select Material_Requirement.Material_Material_Num, Material_Requirement.MR_Amount, Material.Material_Name from Material_Requirement join Material on Material_Requirement.Material_Material_Num = Material.Material_Num where Material_Requirement.Product_Product_Num='" + Product_Num + "'");
