	...
	<%
		...
		try{
			...
			while(rs.next()){
				...
				%>
				<form action="Product_Select_Modify1.jsp" >
	...
	<%
		...
		url = "jdbc:mysql://localhost:3306/system?verifyServerCertificate=false&useSSL=true";
			...
			try {
				...
				while (rs.next()) {
					Material_Num = rs.getString("Material_Material_Num");
	...
	%>
		<table align="center" border="1" width="48%">
			<tr>
				...
				<td><input type="text" name="MR_Amount" value="<%=MR_Amount%>"></td>
			</tr>
		</table>
		<%
				}
