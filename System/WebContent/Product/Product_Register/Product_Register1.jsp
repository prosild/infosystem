...
<ul>
	...
	<li class="topMenuLi">
		...
		<form action="Product_Register2.jsp">
		<table align="center">
				<tr>
					<td align="right">제품번호 :</td>
					<td align="left">
	...
	<%
		...
		String[] Material_Amount = new String[100];

		for (int i = 0; i < Material_num.length; i++) {
			try {
				conn = DriverManager.getConnection(url, "root", "postscript1!");
				stmt = conn.createStatement();
				String sql = "SELECT * FROM Material WHERE Material_Num='" + Material_num[i] + "'";
	...
	%>
		<table align="center" border="1" width="48%">
			<tr>
				...
				<td><input type="text" name="Material_Amount" value="<%=Material_Amount[i]%>"></td>
			</tr>
		</table>
		<%
			}
