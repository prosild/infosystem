...
<h1 align="center">제품입고내역</h1>
	<form action="Product_SR_Register.jsp" >
	...
	<%
		...
		try{
			...
			sql = "SELECT Product_warehousing.Product_Product_Num, Product_warehousing.PW_Date, Product_warehousing.PW_Amount, Product.Product_Name from Product_Warehousing join Product on Product_warehousing.Product_Product_Num = Product.Product_Num";
			rs = stmt.executeQuery(sql);
			
			while(rs.next()){
				Product_Num = rs.getString("Product_Product_Num");
				Product_Name = rs.getString("Product_Name");
				PW_Amount = rs.getString("PW_Amount");
				PW_Date = rs.getString("PW_Date");
			%>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%= PW_Amount %>" disabled>
							</td>
							<td>
								<input type="text" value="<%= PW_Date %>" size="27" disabled>
							</td>
						</tr>
		<% } %>
				</table>
