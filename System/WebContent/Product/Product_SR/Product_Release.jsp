...
<h1 align="center">제품출고내역</h1>
	...
	<%
		...
		try{
			...
			sql = "SELECT Product_release.Product_Product_Num, Product_release.PR_Date, Product_release.PR_Amount, Product.Product_Name from Product_release join Product on Product_release.Product_Product_Num = Product.Product_Num";
			rs = stmt.executeQuery(sql);
			
			while(rs.next()){
				Product_Num = rs.getString("Product_Product_Num");
				Product_Name = rs.getString("Product_Name");
				PR_Amount = rs.getString("PR_Amount");
				PR_Date = rs.getString("PR_Date");
		 %>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%= PR_Amount %>" disabled>
							</td>
							<td>
								<input type="text" value="<%= PR_Date %>" size="27" disabled>
							</td>
						</tr>
		<% } %>
				</table>
