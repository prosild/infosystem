...
<h1 align="center">제품재고내역</h1>
	...
	<%
		...
		String PS_Date = request.getParameter("PS_Date");
		String sql;
		
		try{
			conn = DriverManager.getConnection(url, "root", "postscript1!");
			stmt = conn.createStatement();
			sql = "select Product_stock.Product_Product_Num, Product_stock.PS_Date, Product_stock.PS_Amount, Product.Product_Name from Product_stock join Product on Product_stock.Product_Product_Num = Product.Product_Num where Product.Product_Name = '" + Product_Name + "' and Product_stock.PS_Date like '" + PS_Date + "%'";
		 ...
		 %>
						<tr>
							...
							<td>
								<input type="text" value="<%= PS_Date %>" size="27" disabled>
							</td>
						</tr>
				</table>
			</form>
