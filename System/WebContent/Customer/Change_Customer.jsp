...
<script>
	function goselect(){
		location="Customer_Select.jsp"
	}
	function back(){
		location="Get_Customer.jsp"
	}
		...
		try{
			...
			while(rs.next()){
				...
				%>
						<tr>
							<td>
								<input type="radio" name="Number" value="<%= Cus_Num%>">
							<td>
							...
							<td>
								<input type="text" value="<%= Cus_Tel %>" disabled>
							</td>
							<td>
								<input type="text" value="<%= Cus_Addr %>" disabled>
							</td>
							<td>
								<input type="text" name="Cus_Email" value="<%= Cus_Email %>" disabled>
							</td>
						</tr>
		<% } %>
				</table>
			<center>
				<br>
				<input type="submit" value="선택" onclick="goselect()">
