...
<form action="Set_Customer.jsp" name="C">
	<table align="center">
		...
		<tr>
			...
			<td>
				<input type="text" name="Cus_Name" id="C1">
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td>
				<input type="text" name="Cus_Tel" id="C2">
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td>
				<input type="text" name="Cus_Addr" id="C3" maxlength="40">
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td>
				<input type="text" name="Cus_Email" id="C4">
			</td>
		</tr>
		<tr>
