...
function warehousing(){
	location="Material_Warehousing.jsp"
}
function release(){
	location="Material_Release.jsp"
}
...
<ul>
	...
	<li class="topMenuLi">
		...
		<ul class="submenu">
			<li>
				<a class="submenuLink" href="../Material_Register/Material_Register.jsp">제품등록</a>
			</li>
			<li>
				<a class="submenuLink" href="../Material_Stock/Material_Stock_Check.jsp">제품재고확인</a>			
			</li>
			<li>
				<a class="submenuLink" href="Material_SR_Register.jsp">제품입출고등록</a>			
			</li>
		</ul>
	</li>
	<li class="topMenuLi">
...
<h1 align="center">제품입출고등록</h1>
<form action="Material_SR_Register1.jsp" method="post">
	<table align="center">
		<tr>
			<td>
				제품명 : 
...
<%
		...
		try{
			...
			rs = stmt.executeQuery("select * from SR");
			
			while(rs.next()){
				GS_Name = rs.getString("GS_Name"); %>
			
				<option value="<%=GS_Name%>"><%= GS_Name%></option>
		<%}
		}
	...
	%>
			...
			<td>
				입고 <input type="radio" name="SR" value="입고">
				출고 <input type="radio" name="SR" value="출고">
			</td>
			<td>
				&nbsp;&nbsp;&nbsp;
			</td>
			<td>
				수량 : <input type="text" name="SR_Amount">
			</td>
			<td>
...
<br><br><br><br>
<center>
<button onclick="warehousing()">입고내역</button>
<button onclick="release()">출고내역</button>
</center>
</body>
</html>