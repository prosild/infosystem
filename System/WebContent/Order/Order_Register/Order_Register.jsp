...
<h1 align="center">주문등록</h1>
	...
	<%
		...
		try {
			...
			sql = "SELECT * FROM Customer" + " WHERE Cus_Name LIKE '%" + cus_name + "%'";
	...
	%>
			<tr>
				<td><input type="radio" name="Cus_Num" value="<%=Cus_Num%>">
				<td><input type="text" value="<%=Cus_Num%>" disabled></td>
				<td><input type="text" value="<%=Cus_Name%>" disabled></td>
				<td><input type="text" value="<%=Cus_Tel%>" disabled></td>
				<td><input type="text" value="<%=Cus_Addr%>" disabled></td>
				<td><input type="text" value="<%=Cus_Email%>" disabled></td>
				<td><input type="submit" value="선택"></td>
			</tr>
		<%
			}
		} else if (cus_name == null) {
	%>
			<tr>
				<td><input type="radio">
