...
<ul>
	...
	<li class="topMenuLi">
		...
		<ul class="submenu">
			<li>
				<a class="submenuLink" href="Order_Register.jsp">주문등록</a>
			</li>
			<li>
...
<%
		...
		try{
			...
			rs = stmt.executeQuery("select * from system.Order");
...
<h1 align="center">주문등록</h1>
	...
	<%
		...
		try {
			conn = DriverManager.getConnection(url, "root", "postscript1!");
			stmt = conn.createStatement();
			sql = "SELECT * FROM Customer WHERE Cus_Num='" + Cus_Num + "'";
