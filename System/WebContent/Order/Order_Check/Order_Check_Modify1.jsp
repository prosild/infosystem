...
<nav id="topMenu">
	...
	<h1 align="center">제품선택</h1>
	<form action="Order_Check_Modify2.jsp" method="post">
		...
		try{
			...
			while(rs.next()){
				...
				%>
						<tr>
							<td>
								<input type="checkbox" name="Product_Num" value="<%= Product_Num%>">
							<td>
