...
<h1 align="center">주문내역</h1>
	<form action="Order_Check_Delete1.jsp" method="post">
	...
	<%
		...
		try{
			...
			sql = "select system.order.Order_Num, system.order.Customer_Cus_Num, system.order.Order_Date, system.order.Order_Sum, system.order.Order_Date, Customer.Cus_Name from system.order join customer on system.order.customer_cus_num = customer.cus_num where Order_Date like '" + Order_Date + "%'";
		 ...
		 %>
						<tr>
							<td>
								<input type="radio" name="Order_Num" value="<%=Order_Num %>">
							</td>
							<td>
